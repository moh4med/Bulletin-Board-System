...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        try {
            mserver = new Server(main.serverPort,main.accessNum,main.readernumbers+main.writernumbers);
            mserver.start();
           ...
           //     main.connecttoremote(main.readers.get(i),0,i,main.serverIP,main.serverPort,main.accessNum);
                Client mclient = new Client(0,i,main.serverIP,main.serverPort,main.accessNum);
            }
         ...
         //       main.connecttoremote(main.writers.get(i),1,i,main.serverIP,main.serverPort,main.accessNum);
                Client mclient = new Client(1,i,main.serverIP,main.serverPort,main.accessNum);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
